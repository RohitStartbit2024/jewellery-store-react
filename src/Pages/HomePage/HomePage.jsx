    ...
    return(
        <>
            ...
            <div className=" mt-2 md:mt-24 md:flex">
                ...
                <div className="mt-1 md:mt-0 flex md:block md:ml-5 gap-2 md:gap-0 w-1/3 md:max-h-80">
                    <img src={homeImage[1]} alt="Image-2" className="max-w-1/2 ml-10 md:ml-0 md:w-full"/>
                    <img src={homeImage[2]} alt="Image-2" className="md:mt-5 md:max-h-full md:w-full"/>
                </div>
            </div>
