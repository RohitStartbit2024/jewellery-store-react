export default function(props){
    return(
        <div className="py-2 px-2 md:pt-10 w-full md:w-[30%] aspect-video md:aspect-auto bg-teal-50 text-center">
            <div className="flex px-4 md:px-20 aspect-square md:h-[40%] justify-center">
